...
def redrawAll(canvas, data):
    ...
    #username text
    canvas.create_text(data.width//2,data.sizeX,anchor="c",text=data.username)
    #password text
    canvas.create_text(data.width//2,data.sizeX*2,anchor="c",text=data.password)
    canvas.create_text(data.width//2,data.sizeX*3,anchor="c",text=data.confirmPassword)
